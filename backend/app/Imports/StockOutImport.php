...
class StockOutImport implements ToCollection, WithHeadingRow
{
    ...
    public function collection(Collection $rows): void
    {
        $products = Product::where('is_active', true)
            ->select('id', 'sku', 'name', 'carbon_type', 'reseller_price', 'online_price', 'current_stock')
            ->get();
        ...
        foreach ($rows as $index => $row) {
            ...
            $this->rows[] = [
                ...
                'matched_reseller_price' => $matched?->reseller_price,
                'channel'                => 'langsung', // default, user bisa override
            ];
        }
    }
